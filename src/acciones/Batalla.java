...
public class Batalla {
	...
	public void execute() {
		...
		Gui.setHistoria(personaje.getLocalName() +" se enfrenta a " +secundario+"\n"
		+personaje.getLocalName()+ personaje.hablar("Batalla") + ". \n");
		...
		System.err.println(personaje.getLocalName()+" recibe "+reply.getContent() + "dmg, inflinge"+
				personaje.getPrincipal()+" dmg, su vida actual es "+personaje.getVida());
